...
<section class="mukam-waypoint"  <?php print $headerClass; ?>" <?php print $headerClass; ?>"><!-- data-animate-down="mukam-header-small data-animate-up="mukam-header-large -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 caption">
          ...
          <p>Are you interested in Volunteering with the animals at the SPCA shelter?</p>
        </div>
  ...
  <?php endif; ?> 
  <?php if (!empty($page['content_left5']) || !empty($page['content_right7'])): ?>
    <section class="bg-color grey">          
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            <?php print render($page['content_left5']); ?>          
          </div>
          <div class="col-md-7">
            <?php print render($page['content_right7']); ?>          
          </div>
        </div>
      </div>
    </section>
