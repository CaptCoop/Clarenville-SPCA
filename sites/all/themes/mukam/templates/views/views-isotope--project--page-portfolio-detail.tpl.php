...
?>
  <div  class="col-md-12 portfolio-wrapper">
    <div class="portfolio-style-1">
      <div class="portfolio-1-wrapper" id="isotope-container">
        ...
        <?php foreach ( $rows as $id => $row ): ?>
          ...
          ?>
          <article class="isotope-element isotope-element-<?php print $count; ?> portfolio-item <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
            <?php print $row; ?>
          </article >
          <?php 
          // reset
